  ...
  group('TemperatureChange', () {
    ...
    group('as', () {
      test('converts to unit', () {
        // given
        final temperature = kelvin(1.23456, precision: SignificantDigits(8));
    ...
    group('kelvin', () {
      test('converts to base', () {
        // given
        final temperature = kelvin(1.234, precision: DigitsAfterDecimal(4));
      ...
      test('applies prefixes', () {
        // given
        final temperature =
            milli.kelvin(1234.0, precision: DigitsAfterDecimal(4));
    ...
    group('celsius', () {
      test('converts to base', () {
        // given
        final temperature = celsius(1.234, precision: DigitsAfterDecimal(4));
      ...
      test('applies prefixes', () {
        // given
        final temperature =
            milli.celsius(1234.0, precision: DigitsAfterDecimal(4));
    ...
    group('fahrenheit', () {
      test('converts to base', () {
        // given
        final temperature = fahrenheit(1.234, precision: DigitsAfterDecimal(5));
      ...
      test('applies prefixes', () {
        // given
        final temperature =
            milli.fahrenheit(1234.0, precision: DigitsAfterDecimal(5));
    ...
    group('toString', () {
      ...
      test('maintains units', () {
        // given
        final measurement =
            fahrenheit(3.4).withPrecision(DigitsAfterDecimal(2));
      ...
      test('maintains prefix', () {
        // given
        final measurement =
            milli.fahrenheit(3.4).withPrecision(DigitsAfterDecimal(2));
      ...
      test('extension maintains prefix', () {
        // given
        final measurement =
            3.4.milli.fahrenheit.withPrecision(DigitsAfterDecimal(2));
      ...
      test('modified precision', () {
        // given
        final measurement =
            deci.fahrenheit(23.45).withPrecision(DigitsAfterDecimal(2));
      ...
      test('modified units', () {
        // given
        final measurement =
            deci.fahrenheit(23.45).withPrecision(SignificantDigits(2));
